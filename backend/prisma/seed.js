...
async function main() {
  const products = [
    ...
    {
      name: 'Kesari Gulab Jamun with Ice Cream',
      description: 'Deep-fried milk dumplings soaked in saffron syrup, served warm with vanilla bean gelato.',
      price: 180,
      category: 'Desserts',
      isVeg: true,
      spiceLevel: 'Mild',
  ...
  console.log(`Seeding ${products.length} premium menu items with dietary badges & spice levels...`);
  ...
  console.log(`Seeding ${coupons.length} active promo codes...`);
  ...
  console.log('Successfully completed Artisan menu & promo synchronization!');
}
